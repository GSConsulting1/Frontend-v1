// Menú "⋮" del header de /profesionales/responsables-sec — las dos acciones de
// la pestaña (Nuevo responsable, Eliminar responsables), mismo patrón que
// vobo-acciones-menu.tsx: DropdownMenu + DropdownMenuTrigger
// render={<Button .../>}.
//
// Sin chequeo de rol acá: la pantalla entera ya está gateada en servidor
// (app/profesionales/responsables-sec/page.tsx, getPerfilActual() + redirect).
...
//
// "Nuevo responsable" no navega a otra ruta: abre el formulario de alta inline
...
type ResponsablesSecAccionesMenuProps = {
...
export function ResponsablesSecAccionesMenu({
  onNuevo,
  onEliminar,
}: ResponsablesSecAccionesMenuProps) {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        render={
