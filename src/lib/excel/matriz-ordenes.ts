...
export type MatrizOrdenRow = {
  ...
  checklist:
    ...
    | null;
  acta:
    | (ActaServicio & { profesional_acta: { nombre_completo: string } | null })
    | null;
...
export const COLUMNAS_MATRIZ: ColumnaMatriz[] = [
  ...
  {
    header: "COD Cliente",
    value: (f) => f.orden.cliente?.id ?? f.orden.cliente_id,
  },
  { header: "Cliente", value: (f) => f.orden.cliente?.nombre_cliente ?? "" },
  {
    header: "Número de OS del cliente",
    value: (f) => f.orden.numero_os_cliente ?? "",
  },
  {
    header: "Fecha de recepción OS del cliente",
    value: (f) => fecha(f.orden.fecha_recepcion_os),
  },
  {
    header: "Nombre Empresa usuaria del cliente",
    value: (f) => f.orden.nombre_empresa_usuaria ?? "",
  },
  {
    header: "Nit Empresa usuaria del cliente",
    value: (f) => f.orden.nit_empresa_usuaria ?? "",
  },
  {
    header: "Cronograma (ARL Bolivar)",
  ...
  {
    header: "Tipo Servicio (ARL Bolivar)",
    value: (f) => f.orden.tipo_servicio ?? "",
  },
  {
    header: "Fecha SIPAB (ARL Bolivar)",
    value: (f) => fecha(f.orden.fecha_sipab),
  },
  {
  ...
  {
    header:
      "Observaciones iniciales del cliente (detalle registrada en OS del cliente)",
  ...
  {
    header: "Tiene Valor Transporte",
    value: (f) => f.orden.tarifa_valor_transporte ?? "",
  },
  {
    header: "Responsable SEC para GS",
    value: (f) => f.orden.responsable_os ?? "",
  },
  {
  ...
  {
    header: "Profesional de GS asignado",
    value: (f) => f.info?.profesional?.nombre_completo ?? "",
  },
  {
    header: "Identificación del Profesional de GS asignado",
    value: (f) => f.info?.profesional?.cedula ?? "",
  },
  {
    header: "Numero de contacto del profesional",
    value: (f) => f.info?.profesional?.telefono ?? "",
  },
  {
    header: "Correo del profesional",
    value: (f) => f.info?.profesional?.email ?? "",
  },
  {
    header: "Empresa a visitar",
    value: (f) => f.info?.empresa_a_visitar ?? "",
  },
  {
    header: "Nombre de la actividad a desarrollar",
    value: (f) => f.info?.nombre_actividad ?? "",
  },
  {
    header: "Descripción de la actividad",
    value: (f) => f.info?.descripcion_actividad ?? "",
  },
  {
    header: "N° de horas asignadas al profesional",
    value: (f) => f.info?.horas_asignadas ?? null,
  },
  {
    header: "Fecha de inicio de la ejecución",
    value: (f) => fecha(f.info?.fecha_inicio_ejecucion),
  },
  {
    header: "Fecha de finalización de la ejecución",
    value: (f) => fecha(f.info?.fecha_fin_ejecucion),
  },
  {
    header: "Dirección de la Empresa a visitar",
    value: (f) => f.info?.direccion_empresa ?? "",
  },
  {
    header: "Ubicación en Google Maps",
    value: (f) => f.info?.ubicacion_google_maps ?? "",
  },
  {
    header: "Hora de inicio de la actividad",
    value: (f) => hora(f.info?.hora_inicio),
  },
  {
    header: "Hora de finalización de la actividad",
    value: (f) => hora(f.info?.hora_fin),
  },
  {
  ...
  {
    header: "Entregables especificos",
    value: (f) => f.detalle?.entregables_especificos ?? "",
  },
  {
  ...
  {
    header: "Valor Hora Profesional",
    value: (f) => f.valorHora ?? null,
    money: true,
  },
  {
    header: "Envio de OS al profesional GS",
    value: (f) => siNo(f.detalle?.envio_os_profesional),
  },
  {
    header: "Recepción de la orden de servicio",
    value: (f) => siNo(f.detalle?.recepcion_orden_servicio),
  },
  ...
  { header: "Formatos", value: (f) => siNo(f.checklist?.formatos) },
  {
    ...
    value: (f) => f.checklist?.estado_ejecucion?.nombre ?? "",
  },
  {
    header: "Fecha maxima de ejecución",
    value: (f) => fecha(f.checklist?.fecha_maxima_ejecucion),
  },
  {
  ...
  {
    header: "Informe Guardian",
    value: (f) => f.checklist?.informe_guardian ?? "",
  },

  // ---- Financiera (cuenta_cobro, acta_servicio, facturacion, radicacion_imagine, liquidacion) ----
  {
    header: "Radicación de cuenta de cobro",
    value: (f) => siNo(f.cuentaCobro?.radicacion_cuenta),
    financiera: true,
  },
  {
    header: "Fecha de radicación",
    value: (f) => fecha(f.cuentaCobro?.fecha_radicacion),
    financiera: true,
  },
  {
  ...
  },
  {
    ...
    value: (f) => f.cuentaCobro?.documento_soporte ?? "",
    financiera: true,
  },
  {
    header: "Corte pago",
    value: (f) => f.cuentaCobro?.corte_pago ?? "",
    financiera: true,
  },
  {
  ...
  {
    header: "Estado en IMAGINE",
    value: (f) => f.radicacion?.estado_imagine ?? "",
    financiera: true,
  },
  {
    header: "Fecha del acta",
    value: (f) => fecha(f.acta?.fecha_acta),
    financiera: true,
  },
  {
    header: "Hora del acta",
    value: (f) => hora(f.acta?.hora_acta),
    financiera: true,
  },
  {
  ...
  {
    header: "Fecha de radicación en imagine",
    value: (f) => fecha(f.radicacion?.fecha_radicacion_1),
    financiera: true,
  },
  {
    header: "Número de radicado Imagine",
    value: (f) => f.radicacion?.numero_radicado_1 ?? "",
    financiera: true,
  },
  {
    header: "Novedades Imagine",
    value: (f) => f.radicacion?.novedades_1 ?? "",
    financiera: true,
  },
  {
  ...
  {
    header: "Novedades Imagine por segunda vez",
    value: (f) => f.radicacion?.novedades_2 ?? "",
    financiera: true,
  },
  {
    header: "Actualización SIPAB",
    value: (f) => f.radicacion?.actualizacion_sipab ?? "",
    financiera: true,
  },
  {
    header: "Fecha de corte Imagine",
    value: (f) => fecha(f.radicacion?.fecha_corte),
    financiera: true,
  },
  {
    header: "Estado de facturación",
    value: (f) => f.facturacion?.estado_facturacion ?? "",
    financiera: true,
  },
  {
    header: "Número de prefactura",
    value: (f) => f.facturacion?.numero_prefactura ?? "",
    financiera: true,
  },
  {
    header: "Número de factura",
    value: (f) => f.facturacion?.numero_factura ?? "",
    financiera: true,
  },
  {
    header: "Valor total cotizado",
    value: (f) => f.liquidacion?.valor_total_cotizado ?? null,
    money: true,
    financiera: true,
  },
  {
    header: "Valor desplazamiento",
    value: (f) => f.liquidacion?.valor_desplazamiento ?? null,
    money: true,
    financiera: true,
  },
  {
    header: "Gasto de servicio",
    value: (f) => f.liquidacion?.gasto_servicio ?? null,
    money: true,
    financiera: true,
  },
  {
    header: "IVA",
    value: (f) => f.liquidacion?.iva ?? null,
    money: true,
    financiera: true,
  },
  {
    header: "Valor antes de IVA",
    value: (f) => f.liquidacion?.valor_antes_iva ?? null,
    money: true,
    financiera: true,
  },
  {
    header: "Retención Fuente",
    value: (f) => f.liquidacion?.retencion_fuente ?? null,
    money: true,
    financiera: true,
  },
  {
    header: "Retención IVA",
    value: (f) => f.liquidacion?.retencion_iva ?? null,
    money: true,
    financiera: true,
  },
  {
    header: "Total",
    value: (f) => f.liquidacion?.total ?? null,
    money: true,
    financiera: true,
  },
  {
    header: "Ganacia",
    value: (f) => f.liquidacion?.ganancia ?? null,
    money: true,
    financiera: true,
  },
];
